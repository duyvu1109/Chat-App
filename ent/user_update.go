...
func (uu *UserUpdate) SetMsg(s string) *UserUpdate {
	uu.mutation.SetMsg(s)
	return uu
}

// SetNillableMsg sets the "msg" field if the given value is not nil.
func (uu *UserUpdate) SetNillableMsg(s *string) *UserUpdate {
	if s != nil {
		uu.SetMsg(*s)
	}
	return uu
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Msg(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
...
// SetMsg sets the "msg" field.
func (uuo *UserUpdateOne) SetMsg(s string) *UserUpdateOne {
	uuo.mutation.SetMsg(s)
	return uuo
}

// SetNillableMsg sets the "msg" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableMsg(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetMsg(*s)
	}
	return uuo
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Msg(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: user.FieldMsg,
