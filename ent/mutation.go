...
func (m *UserMutation) SetMsg(s string) {
	m.msg = &s
}

// Msg returns the value of the "msg" field in the mutation.
func (m *UserMutation) Msg() (r string, exists bool) {
	v := m.msg
	if v == nil {
		return
	}
...
// OldMsg returns the old "msg" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldMsg(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) Fields() []string {
	...
	if m.msg != nil {
		fields = append(fields, user.FieldMsg)
	}
	return fields
}
